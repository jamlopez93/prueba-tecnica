            ...
            <div className="flex flex-wrap justify-start  items-center mx-auto max-w-screen-xl">
              <div className="flex items-center lg:order-2 lg:w-full justify-between w-full">
                ...
                <div>
                  <Link
                    href="/posts"
                    className="text-gray-800 bg-primary-700 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-lg px-4 lg:px-5 py-2 lg:py-2.5 mr-2   focus:outline-none "
                  >
                    Entradas
                  </Link>
                </div>
